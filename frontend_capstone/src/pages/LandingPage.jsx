    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-gray-100 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            {user ? (
              <Link to={dashPath} className="bg-green-600 text-white px-5 py-2 rounded-full text-sm font-semibold hover:bg-green-700 transition-colors flex items-center gap-1">
      ...
      <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-20 -left-20 w-72 h-72 bg-green-100 rounded-full blur-3xl opacity-60" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="bg-green-600 text-white px-8 py-3.5 rounded-full text-base font-semibold hover:bg-green-700 transition-all shadow-lg shadow-green-600/25 flex items-center gap-2"
            >
      ...
      {/* ── Stats ── */}
      <section id="stats" className="py-20 bg-green-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
function StepCard({ step, icon, title, desc }) {
  return (
    <div className="text-center">
      <div className="w-14 h-14 rounded-full bg-green-50 text-green-600 flex items-center justify-center mx-auto mb-4 relative">
        {icon}
